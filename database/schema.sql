...
SELECT 'v1.0', 'hifi11-bundle-v1.0.zip', 4200, 'Initial launch release - 2 complete courses.', 1, CURDATE()
WHERE NOT EXISTS (SELECT 1 FROM bundle_versions WHERE version = 'v1.0');
